...
class InMemoryTaskManagerTest {
    ...
    private static final Task TASK_TEST =
            new Task("Test addNewTask", "Test addNewTask description", NEW, TASK);
    private static final Epic EPIC_TEST =
            new Epic("Test addNewEpic", "Test addNewEpic description", NEW, EPIC);
    ...
    void addNewSubtask() {
        ...
        Subtask subtaskTest =
                new Subtask("Subtask", "Subtask description", NEW, SUBTASK, epicId);
    ...
    void updateTask() {
        ...
        Task taskForUpdate =
                new Task("Test addNewTaskForUpdate", "Test addNewTaskForUpdate description", NEW, TASK);
    ...
    void updateEpic() {
        final int epicId = TASK_MANAGER.addNewEpic(EPIC_TEST);
        Epic epicForUpdate =
                new Epic("Test addNewEpicForUpdate", "Test addNewEpicForUpdate description", NEW, EPIC);
    ...
    void updateSubtask() {
        ...
        Subtask subtaskForUpdate =
                new Subtask("SubtaskFotUpdate", "SubtaskFotUpdate description", NEW, SUBTASK, epicId);
